    ...
    return (
        <header>
            <nav class="navbar navbar-expand-lg">
                <div class="container-fluid m-996 divs-center">
                    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
                        <span class="navbar-toggler-icon"></span>
                    </button>
                    <div class="collapse navbar-collapse f-basis-no" id="navbarNav">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                    ...
                    <div class="d-flex">
                        <a class="navbar-brand margin-auto" href="#">
                            <svg>
                    ...
                    <div class="collapse navbar-collapse right-menu f-basis-no">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link">Edición <select><option>es</option><option>en</option></select></a>
                            </li>
                        </ul>
                    </div>
                </div>
